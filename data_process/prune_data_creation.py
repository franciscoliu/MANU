...
data_split_path = "/afs/crc.nd.edu/user/z/zliu29/Private/2024_fall/mllm_unlearn/Data_split"  # Corresponds to folders in image 1
train_data_path = "/afs/crc.nd.edu/user/z/zliu29/Private/2024_fall/mllm_unlearn/Train_data/full_train"  # Corresponds to image 3
output_path = "/afs/crc.nd.edu/user/z/zliu29/Private/2024_fall/mllm_npo/data/prune_data"  # Folder where the new structure will be saved
full_set_data_dir = "/afs/crc.nd.edu/user/z/zliu29/Private/2024_fall/mllm_unlearn/Full_Set"
